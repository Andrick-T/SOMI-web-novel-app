      ...
      <div className="space-y-5 pb-8">
        <section className="rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface)] p-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <label className="text-sm text-[var(--color-text-secondary)]">
              <span className="mb-1 block text-[10px] uppercase tracking-[0.18em] text-[var(--color-text-muted)]">
                Platform name
              </span>
              <input
                value={settings.platformName}
                className="w-full rounded-lg border border-[var(--color-border-default)] bg-[var(--color-background)] px-3 py-2 text-sm text-[var(--color-text-primary)] outline-none"
              />
            </label>
            <label className="text-sm text-[var(--color-text-secondary)]">
              <span className="mb-1 block text-[10px] uppercase tracking-[0.18em] text-[var(--color-text-muted)]">
        ...
        <section className="rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface)] p-4">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={key}
                className="flex w-full items-center justify-between rounded-xl bg-[var(--color-background)] px-3 py-3 text-left"
              >
                ...
                <Toggle
                  ...
                  onChange={(checked) =>
                    toggle(key as keyof typeof settings, checked)
                  }
                  label={String(label)}
                />
              </div>
        ...
        <section className="rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface)] p-4">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-semibold text-[var(--color-text-primary)]">
            <Bell size={14} color="var(--color-accent-primary)" /> Notifications
          </h2>
          <div className="space-y-3">
            {[
        ...
        <section className="rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface)] p-4">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-semibold text-[var(--color-text-primary)]">
            <ShieldCheck size={14} color="var(--color-accent-primary)" />{" "}
            Security
          </h2>
          <div className="grid gap-3 md:grid-cols-2">
            <label className="text-sm text-[var(--color-text-secondary)]">
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button
            ...
            className="somi-control rounded-lg border border-[var(--color-border-default)] bg-[var(--color-background)] px-3 py-2 text-xs font-semibold text-[var(--color-text-secondary)]"
          >
            Reset
          </button>
          <button
            ...
            className="somi-control rounded-lg bg-[var(--color-accent-primary)] px-3 py-2 text-xs font-semibold text-[var(--color-background)]"
          >
            Save changes
          </button>
        </div>
